        ...
        <div
          className={cn(
            ...
            side === "left"
              ...
              : "right-0 group-data-[side=left]:right-auto group-data-[side=left]:left-0",
            "group-data-[collapsible=offcanvas]:w-0",
            variant === "floating" || variant === "inset"
              ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)]"
              : "group-data-[collapsible=icon]:w-[var(--sidebar-width-icon)] border-r group-data-[side=right]:border-l group-data-[side=right]:border-r-0",
            className,
          )}
          {...props}
        >
